class Boolfuck_Interpreter():
    ...
    def execute_boolfuck(self, code, input="", printout=True):
        tape = [0] * 30000
        ...
        while code_index < len(code):
            instruction = code[code_index]class Boolfuck_Interpreter():
    def __init__(self):
        self.tape = [0] * 30000
        pass
    ...
    def execute_brainfuck(self, brainfuck_code, input="", printout=True):
        return(self.execute_boolfuck(self.brainfuck_to_boolfuck(brainfuck_code), input, printout))
